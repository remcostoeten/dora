    ...
    return (
        <div className="flex items-center gap-1 border-b border-border bg-muted/30 px-2">
            <button
                ...
                disabled={disabled}
                className={`flex items-center gap-2 px-3 py-2 text-sm font-medium transition-colors rounded-t-md focus:outline-none ${mode === 'query-runner'
            ...
            <button
                ...
                disabled={disabled}
                className={`flex items-center gap-2 px-3 py-2 text-sm font-medium transition-colors rounded-t-md focus:outline-none ${mode === 'data-browser'
                    ? 'bg-card text-foreground border-b-2 border-primary'
                    : 'text-muted-foreground hover:text-foreground hover:bg-muted/50'
                    } ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
            ...
            <button
                ...
                disabled={disabled}
                className={`flex items-center gap-2 px-3 py-2 text-sm font-medium transition-colors rounded-t-md focus:outline-none ${mode === 'schema-view'
                    ? 'bg-card text-foreground border-b-2 border-primary'
                    : 'text-muted-foreground hover:text-foreground hover:bg-muted/50'
                    } ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
