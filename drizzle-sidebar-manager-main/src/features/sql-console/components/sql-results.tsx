import { Table2, Braces, Download } from "lucide-react";
            ...
            <div className="flex-1 overflow-hidden">
                {!result ? (
                    ...
                    <div className="flex items-center justify-center h-full p-4">
                        <div className="text-red-400 text-sm font-mono bg-red-400/10 px-4 py-3 rounded-md border border-red-400/20 max-w-lg">
                            {result.error}
                        </div>
                    </div>
