...
- SSH tunnel support is now end to end for Postgres desktop connections, including save/update and tunnel startup. The browser/Vercel mock path still omits Tauri tunneling by design.
