...
export const CHANGELOG: ChangelogEntry[] = [
	...
	},
	{
		...
		date: "2026-09-15",
		commit: "v0.41.1",
		title: "Feat: always enable animations in the desktop app and marketing site (#244) (#244)",
		description: "Feat: always enable animations in the desktop app and marketing site (#244) (#244). Feat(studio): render code and migration diffs with @pierre/diffs (#247) (#247).",
		type: "feature",
		details: [
	...
	},
	{
		...
		date: "2026-07-17",
		commit: "v0.35.1",
		title: "Docs(readme): lead with compressed demo tour, tighten intro",
		description: "Docs(readme): lead with compressed demo tour, tighten intro",
		type: "feature",
		details: [
	...
	},
	{
		...
		date: "2026-07-11",
		commit: "v0.33.0",
		title: "Feat(marketing): instrument PostHog and show live HogQL stats",
		description: "Feat(marketing): instrument PostHog and show live HogQL stats. Feat(studio): infer column types for metadata-less query results.",
		type: "feature",
		details: [
