...
export const CHANGELOG: ChangelogEntry[] = [
	...
	},
	{
		...
		date: "2026-07-26",
		commit: "v0.37.0",
		title: "Feat(studio): ctrl/cmd+wheel UI zoom, fix zoom-in key combo",
		description: "Feat(studio): ctrl/cmd+wheel UI zoom, fix zoom-in key combo. Feat(studio): hide-AI setting, macOS window controls, onboarding tour, Drizzle operator intellisense (#222) (#222).",
		type: "feature",
		details: [
