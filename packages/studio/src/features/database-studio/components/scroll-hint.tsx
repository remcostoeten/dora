	...
	return (
		<AnimatePresence>
			{isVisible && (
				...
				>
					<div
						className='relative flex items-center gap-3 px-4 py-3 rounded-lg border border-border bg-popover shadow-lg select-none pointer-events-auto cursor-pointer group'
							...
							<motion.div
								animate={{
									transform: shouldReduceMotion
										? 'translateY(0)'
										: ['translateY(0)', 'translateY(2px)', 'translateY(0)']
								}}
								transition={{
						...
						<div className='flex items-center gap-1 ml-2 text-primary/50'>
							<motion.div
								animate={{
									transform: shouldReduceMotion
										? 'translateX(0)'
										: ['translateX(-1px)', 'translateX(0)', 'translateX(-1px)'],
									opacity: shouldReduceMotion ? 0.75 : [0.65, 0.9, 0.65]
								}}
								transition={{
									repeat: shouldReduceMotion ? 0 : Infinity,
									duration: 2,
