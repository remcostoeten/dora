...
export async function addConnection(
  ...
  return await invoke('add_connection', { name, databaseInfo, color })
}
...
export async function updateConnection(
  ...
  return await invoke('update_connection', { connId: connectionId, name, databaseInfo, color })
}

export async function updateConnectionColor(
  connectionId: string,
  color?: number | null
): Promise<void> {
  return await invoke('update_connection_color', { connectionId, color })
}
