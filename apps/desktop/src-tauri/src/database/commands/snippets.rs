...
pub async fn seed_system_snippets(state: State<'_, AppState>) -> Result<usize, Error> {
    let snippets = vec![
        ...
        SavedQuery {
            ...
            connection_id: None,
            tags: Some("select,basic".to_string()),
            category: Some("Prisma".to_string()),
            created_at: chrono::Utc::now().timestamp(),
            updated_at: chrono::Utc::now().timestamp(),
            favorite: true,
            is_snippet: true,
        ...
        SavedQuery {
            id: 0,
            name: "Filter & sort (Prisma)".to_string(),
            description: Some("findMany with where, orderBy and take".to_string()),
            query_text: "prisma.{model}.findMany({\n  where: { id: { gt: 0 } },\n  orderBy: { id: 'desc' },\n  take: 50,\n})".to_string(),
            connection_id: None,
            tags: Some("select,where,orderby".to_string()),
            category: Some("Prisma".to_string()),
            created_at: chrono::Utc::now().timestamp(),
            updated_at: chrono::Utc::now().timestamp(),
            favorite: false,
        ...
        SavedQuery {
            id: 0,
            name: "Find by ID (Prisma)".to_string(),
            description: Some("findUnique by primary key".to_string()),
            query_text: "prisma.{model}.findUnique({ where: { id: 1 } })".to_string(),
            connection_id: None,
            tags: Some("select,unique".to_string()),
            category: Some("Prisma".to_string()),
            created_at: chrono::Utc::now().timestamp(),
            updated_at: chrono::Utc::now().timestamp(),
            favorite: false,
        ...
        SavedQuery {
            id: 0,
            name: "Count (Prisma)".to_string(),
            description: Some("Count rows, optionally with a where filter".to_string()),
            query_text: "prisma.{model}.count()".to_string(),
            connection_id: None,
            tags: Some("aggregate,count".to_string()),
            category: Some("Prisma".to_string()),
            created_at: chrono::Utc::now().timestamp(),
            updated_at: chrono::Utc::now().timestamp(),
            favorite: false,
        ...
        SavedQuery {
            id: 0,
            name: "Create (Prisma)".to_string(),
            description: Some("Insert a row with create".to_string()),
            query_text: "prisma.{model}.create({\n  data: { name: 'example' },\n})".to_string(),
            connection_id: None,
            tags: Some("insert,write".to_string()),
            category: Some("Prisma".to_string()),
            created_at: chrono::Utc::now().timestamp(),
            updated_at: chrono::Utc::now().timestamp(),
            favorite: false,
        ...
        SavedQuery {
            id: 0,
            name: "Update (Prisma)".to_string(),
            description: Some("Update a row by id".to_string()),
            query_text: "prisma.{model}.update({\n  where: { id: 1 },\n  data: { name: 'updated' },\n})".to_string(),
            connection_id: None,
            tags: Some("update,write".to_string()),
            category: Some("Prisma".to_string()),
            created_at: chrono::Utc::now().timestamp(),
            updated_at: chrono::Utc::now().timestamp(),
            favorite: false,
        ...
        SavedQuery {
            id: 0,
            name: "Delete (Prisma)".to_string(),
            description: Some("Delete a row by id".to_string()),
            query_text: "prisma.{model}.delete({ where: { id: 1 } })".to_string(),
            connection_id: None,
            tags: Some("delete,write".to_string()),
            category: Some("Prisma".to_string()),
            created_at: chrono::Utc::now().timestamp(),
            updated_at: chrono::Utc::now().timestamp(),
            favorite: false,
        ...
        SavedQuery {
            id: 0,
            name: "Raw SQL (Prisma)".to_string(),
            description: Some("Escape hatch — run raw SQL via $queryRaw".to_string()),
            query_text: "prisma.$queryRaw`SELECT * FROM {table_name} LIMIT 10`".to_string(),
            connection_id: None,
            tags: Some("raw,sql".to_string()),
            category: Some("Prisma".to_string()),
            created_at: chrono::Utc::now().timestamp(),
            updated_at: chrono::Utc::now().timestamp(),
            favorite: false,
