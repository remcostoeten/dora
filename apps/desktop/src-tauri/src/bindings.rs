...
pub fn generate_bindings() -> Builder<tauri::Wry> {
    ...
    Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        db_commands::posthog_save_credentials,
        db_commands::posthog_run_query,
        db_commands::posthog_config,
        db_commands::posthog_disconnect,
        db_commands::posthog_is_connected,
        ...
        crate::commands::build_cache::get_build_cache_stats,
        crate::commands::build_cache::clean_build_cache
    ])
}
...
pub fn export_ts_bindings() {
    let output_path = std::path::Path::new(env!("CARGO_MANIFEST_DIR"))
        .join("../../../packages/studio/src/lib/bindings.ts");
    generate_bindings()
        .export(
