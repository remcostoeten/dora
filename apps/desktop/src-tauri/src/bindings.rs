...
pub fn generate_bindings() -> Builder<tauri::Wry> {
    ...
    Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        db_commands::xata_save_token,
        db_commands::xata_list_databases,
        db_commands::xata_build_connection_string,
        db_commands::xata_account,
        db_commands::xata_disconnect,
        db_commands::xata_is_connected,
