...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            database::commands::posthog_save_credentials,
            database::commands::posthog_run_query,
            database::commands::posthog_config,
            database::commands::posthog_disconnect,
            database::commands::posthog_is_connected,
