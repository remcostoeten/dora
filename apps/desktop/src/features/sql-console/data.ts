...
export const MOCK_TABLES: TableInfo[] = [
    {
        name: "categories", type: "table", rowCount: 8, columns: [
    ...
    {
        name: "customers", type: "table", rowCount: 93, columns: [
    ...
    {
        name: "employee_territories", type: "table", rowCount: 49, columns: [
    ...
    {
        name: "employees", type: "table", rowCount: 9, columns: [
    ...
    {
        name: "order_details", type: "table", rowCount: 2155, columns: [
    ...
    {
        name: "orders", type: "table", rowCount: 830, columns: [
            { name: "id", type: "serial", nullable: false, primaryKey: true },
    ...
    {
        name: "products", type: "table", rowCount: 77, columns: [
            { name: "id", type: "serial", nullable: false, primaryKey: true },
    ...
    { name: "regions", type: "table", rowCount: 4, columns: [{ name: "region_id", type: "integer", primaryKey: true }, { name: "region_description", type: "varchar(50)" }] },
    { name: "shippers", type: "table", rowCount: 3, columns: [{ name: "shipper_id", type: "serial", primaryKey: true }, { name: "company_name", type: "varchar(40)" }] },
    { name: "suppliers", type: "table", rowCount: 29, columns: [{ name: "supplier_id", type: "serial", primaryKey: true }, { name: "company_name", type: "varchar(40)" }] },
    { name: "territories", type: "table", rowCount: 53, columns: [{ name: "territory_id", type: "varchar(20)", primaryKey: true }, { name: "territory_description", type: "varchar(50)" }] },
