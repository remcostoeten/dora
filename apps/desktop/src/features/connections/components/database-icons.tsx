...
export function SQLiteIcon({ className }: Props) {
	return (
		<svg
			...
			xmlns='http://www.w3.org/2000/svg'
		>
			<rect x='4' y='2' width='16' height='20' rx='2' className='fill-[#0F3B5F]' />
			<path
...
export function LibSQLIcon({ className }: Props) {
	return (
		<svg
			...
			xmlns='http://www.w3.org/2000/svg'
		>
			<path d='M12 2L3 7V17L12 22L21 17V7L12 2Z' className='fill-[#00D4AA]' />
			<path d='M12 2V22' stroke='white' strokeWidth='1.5' className='opacity-40' />
			<path d='M3 7L12 12L21 7' stroke='white' strokeWidth='1.5' className='opacity-40' />
