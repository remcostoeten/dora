        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[560px] max-h-[85vh] flex flex-col glass border-border/50 p-0 gap-0 overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-5">
                    ...
                    {testMessage && (
                        <div className={`text-sm p-3 rounded-md flex items-center gap-2 ${testStatus === "success"
                                ? "bg-green-500/10 text-green-500 border border-green-500/20"
                                : "bg-red-500/10 text-red-500 border border-red-500/20"
                            }`}>
                            <div className={`h-2 w-2 rounded-full ${testStatus === "success" ? "bg-green-500" : "bg-red-500"
                                }`} />
                            {testMessage}
                        </div>
                    )}
