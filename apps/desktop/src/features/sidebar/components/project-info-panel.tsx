...
import { CURRENT_VERSION } from "../changelog-data"; // Assuming this exists based on previous file
                ...
                <div className="p-4">
                    <SidebarSection title="About">
                        <p className="text-sm text-sidebar-foreground leading-relaxed">
                            Dora is a modern database management tool designed for developer happiness.
                        ...
                        <div className="grid gap-2">
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-xs text-muted-foreground">Source code & Issues</div>
                                </div>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-xs text-muted-foreground">Latest releases</div>
                                </div>
                                <ExternalLink className="h-3 w-3 text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity" />
                            </a>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-xs text-muted-foreground">remcostoeten.com</div>
                                </div>
                                <ExternalLink className="h-3 w-3 text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity" />
                            </a>
                        </div>
                        ...
                        <div className="flex items-center gap-3 p-2 rounded-md bg-sidebar-accent/30 border border-sidebar-border/50">
                            ...
                            <div>
                                ...
                                <div className="text-xs text-muted-foreground flex items-center gap-1">
                                    Made with <Heart className="h-3 w-3 text-red-500 fill-red-500 inline" /> in The Netherlands
                                </div>
                            </div>
                        </div>
                    </SidebarSection>
