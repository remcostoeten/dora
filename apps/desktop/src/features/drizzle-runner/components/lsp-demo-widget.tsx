...
export function LspDemoWidget({ editorRef, onClose }: Props) {
	...
	const setEditorContent = useCallback(
		function setEditorContent(content: string, cursorAtEnd = true): void {
	...
	const typeStep = useCallback(
		function typeStep(stepData: DemoStep, charIndex: number, startTextLength: number): void {
			...
			<div className='flex flex-row items-center justify-between p-4 pb-2'>
				...
				<div className='flex gap-1'>
					<Button
						...
						size='icon'
						className='h-6 w-6'
						onClick={function toggleSettings() {
