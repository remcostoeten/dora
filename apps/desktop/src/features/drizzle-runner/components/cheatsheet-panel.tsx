...
const OPERATORS: Snippet[] = [
	...
	},
	{
		...
		code: 'gt(column, value)',
		description: 'column > value',
		category: 'Operators'
	},
	{
		id: 'gte',
		label: 'Greater or equal (gte)',
		code: 'gte(column, value)',
		description: 'column >= value',
		category: 'Operators'
	},
	{
		id: 'lt',
		label: 'Less than (lt)',
		code: 'lt(column, value)',
		description: 'column < value',
		category: 'Operators'
	},
	{
		id: 'lte',
		label: 'Less or equal (lte)',
		code: 'lte(column, value)',
		description: 'column <= value',
		category: 'Operators'
	},
	{
	...
	},
	{
		id: 'and',
		label: 'AND',
		code: 'and(cond1, cond2)',
		description: 'Combine with AND',
		category: 'Operators'
	},
	{
		id: 'or',
...
export function CheatsheetPanel({ isOpen, onToggle, onInsertSnippet }: Props) {
	...
	const groupedSnippets = HINTS.reduce(
		function (acc, snippet) {
