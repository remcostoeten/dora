...
function ThemeToggle({ variant }: TTogle) {
  ...
  useEffect(() => {
    ...
    setIsDark(settings.theme === "dark" || settings.theme === "midnight" || settings.theme === "forest" || settings.theme === "claude-dark");
  }, []);
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          ...
          aria-label={isFloating ? "Switch to docked sidebar" : "Switch to floating sidebar"}
