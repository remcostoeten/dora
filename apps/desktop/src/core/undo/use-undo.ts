...
export function useUndo(options: UndoOptions = {}) {
    ...
    const performUndo = useCallback(async function(mutation: Mutation): Promise<boolean> {
        try {
    ...
    const undoLatest = useCallback(async function() {
    ...
    const trackCellMutation = useCallback(function(
        connectionId: string,
        tableName: string,
    ...
    const trackBatchCellMutation = useCallback(function(
        connectionId: string,
        tableName: string,
        primaryKeyColumn: string,
        cells: Array<{
