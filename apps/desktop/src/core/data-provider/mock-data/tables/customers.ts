const FIRST_NAMES = ["Emma", "Liam", "Olivia", "Noah", "Ava", "Elijah", "Sophia", "James", "Isabella", "Oliver", "Mia", "Benjamin", "Charlotte", "Lucas", "Amelia", "Mason", "Harper", "Ethan", "Evelyn", "Alexander"];
...
const COUNTRIES = ["USA", "Canada", "UK", "Germany", "France", "Australia", "Netherlands", "Sweden", "Norway", "Denmark"];
