...
export function PendingEditsProvider({ children }: Props) {
    ...
    const getEditsForTable = useCallback(function (tableId: string): PendingEdit[] {
    ...
    const getEditCount = useCallback(function (tableId?: string): number {
        if (tableId) {
            let count = 0;
    ...
    const hasEdits = useCallback(function (tableId?: string): boolean {
