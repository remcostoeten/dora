...
import { useShortcut as useShortcutBase, type UseShortcutOptions } from "@/shared/lib/use-shortcut"
...
export function getShortcutsByScope(scope: ShortcutDefinition["scope"]): Array<{ name: ShortcutName; definition: ShortcutDefinition }> {
