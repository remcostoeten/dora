...
export const commands = {
	...
	async addConnection(
		...
		color: number | null
	): Promise<Result<ConnectionInfo, any>> {
		try {
			return {
				status: 'ok',
	...
	async updateConnection(
		...
		try {
			return {
				status: 'ok',
				data: await TAURI_INVOKE('update_connection', { connId, name, databaseInfo, color })
			}
		} catch (e) {
			if (e instanceof Error) throw e
			else return { status: 'error', error: e as any }
	...
	async getConnectionHistory(
		...
		limit: number | null
	): Promise<Result<ConnectionHistoryEntry[], any>> {
		try {
			return {
				status: 'ok',
	...
	async getQueryHistory(
		connectionId: string,
		limit: number | null
	): Promise<Result<QueryHistoryEntry[], any>> {
		try {
			return {
				status: 'ok',
	...
	): Promise<Result<LiveMonitorSession, any>> {
		try {
			return {
				status: 'ok',
	...
	): Promise<Result<MutationResult, any>> {
		try {
			return {
				status: 'ok',
	...
	): Promise<Result<SoftDeleteResult, any>> {
		try {
			return {
				status: 'ok',
	...
	): Promise<Result<TruncateResult, any>> {
		try {
			return {
				status: 'ok',
