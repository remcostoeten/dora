...
export const getTablesBySchema = (databaseId: string, schemaName: string): TableItem[] => {
...
const SCHEMA_TABLES: Record<string, TableItem[]> = {
  ...
  "ecommerce_db.analytics": [
    ...
    { id: "funnel_analytics", name: "funnel_analytics", rowCount: 1250000, type: "materialized-view" },
  ...
  "ecommerce_db.reporting": [
    ...
    { id: "customer_lifetime_value", name: "customer_lifetime_value", rowCount: 12543, type: "materialized-view" },
  ],
  "user_service.main": [
  ...
  "user_service.notifications": [
    ...
    { id: "notification_preferences", name: "notification_preferences", rowCount: 89000, type: "table" },
