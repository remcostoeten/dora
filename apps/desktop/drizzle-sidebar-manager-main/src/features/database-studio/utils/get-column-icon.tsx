...
export function getColumnIcon(type: string) {
    ...
    if (normalizeType.includes("char") ||
    ...
    if (normalizeType.includes("timestamp") ||
        normalizeType.includes("date")) {
        return Calendar;
    }
    ...
    if (normalizeType.includes("json") ||
        normalizeType.includes("jsonb")) {
        return Braces;
    }
