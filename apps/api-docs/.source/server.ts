...
export const docs = await create.docs(
	'docs',
	'content/docs',
	{ 'meta.json': __fd_glob_0, 'guides/meta.json': __fd_glob_1 },
	{
		'api.mdx': __fd_glob_2,
		'index.mdx': __fd_glob_3,
		'installation.mdx': __fd_glob_4,
		'test.mdx': __fd_glob_5,
		'types.mdx': __fd_glob_6,
		'guides/mock-data.mdx': __fd_glob_7,
		'guides/new-features.mdx': __fd_glob_8
	}
)
