            ...
            <span className="relative h-px w-6 shrink-0 self-center overflow-visible bg-line">
                <span
                    ...
                    style={{
                        ...
                        boxShadow:
                            '0 0 6px color-mix(in srgb, var(--color-brand-200) 80%, transparent)',
                        opacity: saved ? 1 : 0,
                        transform: saved ? 'translateX(24px)' : 'translateX(0)',
            ...
            <span
                ...
                style={{
                    ...
                    backgroundColor: saved
                        ? 'color-mix(in srgb, var(--color-brand-200) 12%, transparent)'
                        : 'transparent',
                    color: saved
                        ? 'var(--color-brand-200)'
                        : 'var(--color-ink-700)',
                    boxShadow: saved
                        ? '0 0 16px color-mix(in srgb, var(--color-brand-200) 40%, transparent)'
                        : '0 0 0 transparent',
                    transform: saved ? 'scale(1)' : 'scale(0.96)',
            ...
            >
                <span
                    ...
                    style={{
                        ...
                        boxShadow: saved
                            ? '0 0 8px color-mix(in srgb, var(--color-brand-200) 90%, transparent)'
                            : 'none',
