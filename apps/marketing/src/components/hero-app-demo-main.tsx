...
const GRID_COLS = 'grid-cols-[36px_60px_180px_236px_158px_126px_114px_180px]'
...
export function DemoMain({ activeTable }: { activeTable: string }) {
    ...
    return (
        <main className="flex-1 flex flex-col h-full overflow-hidden relative">
            ...
            {/* Selection action bar — static (docked) variant, 1:1 with the real
                studio SelectionActionBar (packages/studio .../selection-action-bar.tsx) */}
            <AnimatePresence>
                {selectedRows.length > 0 && (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-0.5">
                            <BarButton icon={Copy} label="Copy" shortcut="C" />
                            <BarButton icon={CopyPlus} label="Duplicate" />
            ...
            <div className="flex items-center justify-between h-10 px-3 bg-sidebar border-t border-sidebar-border shrink-0">
                <div className="flex items-center gap-3 text-xs text-muted-foreground">
                    ...
                    <span>
                        Showing 1-{displayRows.length} of {displayRows.length}{' '}
                        rows
                    </span>
                </div>
