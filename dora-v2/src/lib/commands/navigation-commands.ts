...
export const navigationCommands: AppCommand[] = [
  {
    ...
    description: 'Show the left sidebar panel',
    icon: Sidebar,
    group: 'navigation',
    shortcut: '⌘+1',
...

  {
    ...
    description: 'Hide the left sidebar panel',
    icon: Sidebar,
    group: 'navigation',
    shortcut: '⌘+1',
...

  {
    ...
    description: 'Show the right sidebar panel',
    icon: PanelRight,
    group: 'navigation',
    shortcut: '⌘+2',
...

  {
    ...
    description: 'Hide the right sidebar panel',
    icon: PanelRight,
    group: 'navigation',
    shortcut: '⌘+2',
